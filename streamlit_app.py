...
if st.session_state.step >= 4:
    ...
    if st.button("Generate Section"):
        ...
        #  Debug Info to check before generation
        ...
        st.write("Search Results Preview:", st.session_state.search_results[:500])  # First 500 characters

        chain = writer_prompt | ollama_model | StrOutputParser()
    ...
    if st.session_state.written_section:
        st.markdown(st.session_state.written_section)
